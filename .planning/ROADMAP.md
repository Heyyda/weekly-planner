...
- [x] 03-11-PLAN.md — Wave 5: E2E tests + 03-VALIDATION.md update + human-verify checkpoint (17 пунктов)
...
**Plans:** 11/11 plans executed (human-verify остался)
...
- [x] 04-04-PLAN.md — Wave 2: client/ui/day_section.py — header + 7 DaySection + empty '+' + inline add — WEEK-01, TASK-07
- [x] 04-05-PLAN.md — Wave 2: client/ui/week_navigation.py — prev/next/today + archive detect + keyboard + interpolate_palette — WEEK-02/03/06
- [x] 04-06-PLAN.md — Wave 3: client/ui/quick_capture.py — CTkToplevel popup + parse + edge-flip — TASK-01, TASK-07
- [x] 04-07-PLAN.md — Wave 3: client/ui/edit_dialog.py — modal + 4 fields + validation + grab_release — TASK-03
- [x] 04-08-PLAN.md — Wave 4: client/ui/undo_toast.py — CTkFrame + place + countdown + max 3 stack — TASK-04
- [x] 04-09-PLAN.md — Wave 4: client/ui/drag_controller.py — Approach 2 per 04-RESEARCH-DND (mouse bindings + ghost Toplevel + bbox hit-test) — TASK-05, TASK-06
- [x] 04-10-PLAN.md — Wave 5: client/ui/main_window.py + client/app.py integration — всё wired — все 13 REQ-IDs
- [x] 04-11-PLAN.md — Wave 5: E2E integration tests (16 scenarios) + human-verify checkpoint ⏳ — final sign-off pending
