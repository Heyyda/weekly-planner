...
На рабочем столе живёт перетаскиваемый синий квадратик — клик открывает окно с задачами текущей недели. Задачи синхронизируются между ПК и Telegram-ботом.
...
### Десктоп
- **Синий overlay-квадратик** на рабочем столе (можно перетаскивать)
- **Главное окно** — 7 дней недели, компактный вид
...
- **Drag-and-drop** задач между днями мышкой
- **Edit dialog** — редактирование текста, дня, времени, статуса
